...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    private static final long serialVersionUID = 607674678L;
    ...
    public final UMC.spring.domain.QPrefer prefer;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.prefer = inits.isInitialized("prefer") ? new UMC.spring.domain.QPrefer(forProperty("prefer")) : null;
    }
